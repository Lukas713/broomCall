      ...
      <div class="modal-body">
        <form method="post" action="<?php echo $_SERVER["PHP_SELF"];?>">
          ...
          <div class="form-group">	
              ...
              <input type="password" id="registerPassword" autocomplete="new-password" name="registerPassword" <?php echo empty($error["registerPassword"]) ?  'class="form-control"' : ' class="form-control is-invalid" ' ;?>>
